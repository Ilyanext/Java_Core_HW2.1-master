...
public class Main {
    public static void main(String[] args) throws TransportTypeException {
        ...
        ArrayList<Mechanic> mersMechanics = new ArrayList<>();
        mersMechanics.add(new Mechanic("Fod", "Andi"));
        mersMechanics.add(new Mechanic("FodI", "AndiB"));

        PassengerCars carMers = new PassengerCars("Mers", "yu-43", 1.1, oleg, BodyType.KUPE, mersMechanics);
